...
{
    public class AddActivityPlanFileHandler : IRequestHandler<AddActivityPlanFileEvent>
    {
        private readonly IHostingEnvironment _webHostEnv;

        public AddActivityPlanFileHandler ( IHostingEnvironment webHostEnv )
        {
            _webHostEnv = webHostEnv;
        }

        public async Task<Unit> Handle ( AddActivityPlanFileEvent request , CancellationToken cancellationToken )
        {
