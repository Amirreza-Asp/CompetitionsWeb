...
namespace Competitions.Persistence.Migrations
{
    ...
    [Migration("20221016130724_AddTeamAndUserTeamTables")]
    partial class AddTeamAndUserTeamTables
    {
            ...
            modelBuilder.Entity("Competitions.Domain.Entities.Managment.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 16, 16, 37, 24, 362, DateTimeKind.Local).AddTicks(8258));
